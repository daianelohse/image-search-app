        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed w-full top-0 left-0 z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a className="flex items-center space-x-3 rtl:space-x-reverse">
                    <Link to="/">  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">mediasearch</span></Link>
                </a>
                ...
                {isSearchPage && (
                    <div className="flex-1 max-w-md">
                        <ImageSearch searchText={onSearch} searchedWord={searchedWord} />
                    </div>
                )}
